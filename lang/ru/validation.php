...
return [
    ...
    'custom' => [
        'client_phone' => [
            'regex' => 'Укажите телефон в формате +7 и 10 цифр, например +7 960 701 12 63.',
        ],
        'last_name' => [
        ...
        'middle_name' => [
            'regex' => 'Отчество может содержать только буквы.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'server_type' => 'сервер',
        'city_id' => 'город клиента',
        'equipment_type' => 'вид работ',
        'reference_source_id' => 'источник заказа',
        'source_id' => 'источник заказа',
        'order_date' => 'дата визита',
        'meeting_time' => 'время визита',
        'street' => 'улица',
        'house' => 'дом',
        'flat' => 'квартира/офис',
        'address_adds' => 'дополнение к адресу',
        'order_adds' => 'комментарий к заявке',
        'order_type' => 'тип заявки',
        'without_call' => 'без звонка',
        ...
        'role' => 'роль',
        'parent_user_id' => 'партнёр',
        'city_ids' => 'города',
        'source_ids' => 'источники',
        'direction_codes' => 'направления',
        'amount' => 'сумма',

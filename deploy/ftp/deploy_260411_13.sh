#!/usr/bin/env bash
# =============================================================================
# Деплой 11.04.2026 (#13) — SuperPart.ru: LevelionApiService (подсказка HTTP 500, crmApiUrl)
#
# Файлы:
#   - app/Services/LevelionApiService.php — LEVELION_API_PATH_PREFIX, текст ошибки при 500
#
# FTP (reg.ru): u3398705_cursor_sp — домашний каталог = корень Laravel SuperPart.
#
# Запуск из корня репозитория superpart.ru:
#   FTP_PASS='…' bash ./deploy/ftp/deploy_260411_13.sh
# =============================================================================
set -euo pipefail
...
FILES=(
  ...
  "deploy/ftp/deploy_260411_13.sh"
)

echo "============================================================================="
echo "${SCRIPT_BASENAME} — SuperPart.ru (LevelionApiService)"
...
Если на сервере ещё не выгружали config/services.php с LEVELION_API_PATH_PREFIX — выполните deploy_260411_12.sh или добавьте этот файл вручную.
